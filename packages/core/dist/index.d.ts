...
declare function waitForElementDimensions<T extends HTMLElement>(element: T): Promise<void>;

export { type UnLazyLoadOptions, autoSizes, base64ToBytes, createPlaceholderFromHash, debounce, getScaledDimensions, isCrawler, isLazyLoadingSupported, isSSR, lazyLoad, loadImage, toElementArray, waitForElementDimensions };
